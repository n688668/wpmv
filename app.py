...
class UniversalViewer(QMainWindow):
    ...
    def set_app_icon(self):
        ...
        if os.path.exists(icon_path):
            ...
            # Tạo icon tạm thời bằng code nếu không có file icon.ico để tránh trống icon
            ...
            triangle = QPolygonF([QPoint(85, 70), QPoint(85, 186), QPoint(190, 128)])
...
if __name__ == '__main__':
    ...
    app.setApplicationName("WPMV Player") # Tên ứng dụng đồng nhất
    app.setStyle("Fusion")
